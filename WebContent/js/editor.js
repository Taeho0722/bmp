              ...
              function(config, parserConfig) {
                ...
                function maybePopContext(state, nextTagName) {
                  ...
                  while (true) {
                    ...
                    if (!Kludges.contextGrabbers
                        .hasOwnProperty(parentTagName)
                        || !Kludges.contextGrabbers[parentTagName]
                ...
                function closeTagNameState(type, stream, state) {
                  if (type == "word") {
                    ...
                    if (state.context
                        ...
                        && Kludges.implicitlyClosed
                            .hasOwnProperty(state.context.tagName))
                      popContext(state);
                    if (state.context
                        && state.context.tagName == tagName) {
                      setStyle = "tag";
                ...
                function attrState(type, _stream, state) {
                  if (type == "word") {
                    ...
                    if (type == "selfcloseTag"
                        || Kludges.autoSelfClosers
                            .hasOwnProperty(tagName)) {
                      maybePopContext(state, tagName)
                    } else {
                      maybePopContext(state, tagName);
                      state.context = new Context(state,
                          tagName,
                ...
                return {
                    ...
                    if (tagAfter && tagAfter[1]) {
                      while (context) {
                        if (context.tagName == tagAfter[2]) {
                          ...
                          break
                        } else if (Kludges.implicitlyClosed
                            .hasOwnProperty(context.tagName)) {
                          context = context.prev
                        } else {
                          break
                        }
                  ...
                  blockCommentStart : "<!--",
                  blockCommentEnd : "-->",
                  configuration : parserConfig.htmlMode ? "html"
                      : "xml",
                  helperType : parserConfig.htmlMode ? "html"
                      : "xml"
                }
              });
