...
function pageMove(flag){
	...
	if(flag == "1"){actionUrl = "web_chart_shinhancard_info_sub.jsp";}
	 	...
	 	$.ajax({
  		...
  		beforeSend : function(){
  	 	...
  	 	success:function(result) {
  			$("#brandResult").html(result);//id가 tab_content에 내용을 보여줌
              ...
              <div class="camp_inquiry2">
                <dl>
                  <dd>
                    ...
                    <a href="javascript:popupMd();" id="md_popup">MD검색</a>
                    <a href="javascript:search();">조회하기</a>
                  </dd>
                </dl>
              </div>
            </div>
          </div>
          <div class="brandResult_wrap2 clear" id="brandResult">
          </div>
        </div>
      </div>
    </div>
